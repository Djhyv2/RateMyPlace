<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompareHousing.aspx.cs" Inherits="RateMyPlace.Pages.CompareHousing" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Compare Housing</title>
    <meta charset="utf-8">
...
<body id="compareHousingBody">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div id="content">
            <div id="tableBox">
            <h1 id="tableHeading">Compare Housing</h1>
                <table>
                    <tr id="firstRow">
                        <th></th>
                        <th>Brookside</th>
